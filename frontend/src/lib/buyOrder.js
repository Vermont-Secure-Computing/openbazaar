...
import solBazaarIdl from "../idl/sol_bazaar.json";
...
export async function createBuyOrder({
    ...
    const createOrderRecordInstruction =
        await solBazaarProgram.methods
            .createOrderRecord(
                quantityNumber
            )
            .accounts({
